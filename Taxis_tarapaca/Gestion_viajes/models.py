...
class Geolocalizacione(models.Model):
...
class Viaje(models.Model):
    id = models.AutoField(primary_key=True)  # este se usara como FK
    ...
    origen = models.CharField(max_length=255, blank=True, null=True)  # agregar tipo_origen
    deleted_at = models.DateTimeField(blank=True, null=True)
